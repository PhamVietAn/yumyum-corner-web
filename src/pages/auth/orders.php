...
<head>
  ...
  <title>Đơn hàng của tôi | YumYum Corners</title>
...
<body class="orders-body">
  ...
  <main class="orders-page">
    <div class="orders-container">
      ...
      <section id="ordersEmpty" class="orders-empty hidden">
        <i class="fa-solid fa-box-open empty-icon"></i>
        <h2>Chưa có đơn hàng nào</h2>
        <p>Hãy bắt đầu mua sắm và khám phá các món ngon của YumYum Corners.</p>
        <a href="products.php" class="empty-btn">Khám phá sản phẩm</a>
      </section>
    </div>
  </main>

  <div id="orderModal" class="orders-modal hidden" aria-hidden="true">
    <div class="orders-modal-dialog" role="dialog" aria-modal="true" aria-labelledby="orderModalTitle">
      <button class="orders-modal-close" type="button" id="closeOrderModalBtn" aria-label="Đóng chi tiết">
  ...
  <div id="ordersToast" class="orders-toast" role="status" aria-live="polite"></div>
  ...
  <script src="../../js/auth/orders.js"></script>
</body>
</html>
